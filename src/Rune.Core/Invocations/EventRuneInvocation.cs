...
{
    public override RuneEventType EventType => RuneEventType.MessageCreate;
}
...
public sealed record MessageDeleteEventRuneInvocation(
    ...
    : EventRuneInvocation(InvocationId, GuildId)
{
    public override RuneEventType EventType => RuneEventType.MessageDelete;
}
...
public sealed record MessageReactionAddEventRuneInvocation(
    ...
    : EventRuneInvocation(InvocationId, GuildId)
{
    public override RuneEventType EventType => RuneEventType.MessageReactionAdd;
}
...
public sealed record MessageReactionRemoveEventRuneInvocation(
    ...
    : EventRuneInvocation(InvocationId, GuildId)
{
    public override RuneEventType EventType => RuneEventType.MessageReactionRemove;
}
